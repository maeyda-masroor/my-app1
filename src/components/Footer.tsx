...
export default function Footer(){
    return (
    <footer className="bg-gradient-to-r from-pink-800 via-pink-600 to-pink-800 py-12 px-10 font-sans tracking-wide">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-200 text-[15px]">Subscribe to stay updated with the latest news, offers, and exclusive content.
          ...
          <div className="flex mt-6">
            ...
            <button className="bg-blue-600 text-white rounded-r py-3 px-4 text-[15px] tracking-wide">Subscribe</button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Our Story</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Newsroom</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Careers</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Blog</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Web Development</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Testing Automation</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">AWS Development Services</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Mobile App Development</a>
            </li>
          </ul>
        </div>

        <div>
          <h4 className="text-white font-semibold text-lg mb-6">Platforms</h4>
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Hubspot</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Marketo Integration Services</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Marketing Glossary</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">UIPath</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Accessibility</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">About</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Contact</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">Learn more</a>
            </li>
          </ul>
        </div>
      </div>
