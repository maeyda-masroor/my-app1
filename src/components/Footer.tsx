...
export default function Footer(){
    return (
    <footer className="bg-gradient-to-r from-red-800 via-red-600 to-red-800 py-12 px-10 font-sans tracking-wide">
  ...
  <li><a href="javascript:void(0)">
    <svg xmlns="http://www.w3.org/2000/svg" className="inline w-6 h-6" viewBox="0 0 1227 1227">
      ...
      <path fill="#fff" d="m680.617 557.98 262.632-305.288h-62.235L652.97 517.77 470.833 252.692H260.759l275.427 400.844-275.427 320.142h62.239l240.82-279.931 192.35 279.931h210.074L680.601 557.98zM345.423 299.545h95.595l440.024 629.411h-95.595z" data-original="#ffffff" />
        ...
        <div className="mb-6">
          <h4 className="text-white font-semibold text-lg mb-6">Quick link</h4>
          <ul className="space-y-4">
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">About Noor Foundation</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="hover:text-white text-gray-200 text-[15px]">News</a>
            </li>
            <li>
